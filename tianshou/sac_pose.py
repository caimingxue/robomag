...
def get_args():
    ...
    parser.add_argument('--task', type=str, default='LineFollower-v0')
...
def test_sac(args=get_args()):
    ...
    if __name__ == '__main__':
        ...
        # policy.eval()
        policy.load_state_dict(torch.load("/home/cmx/Documents/Work_Code/gym-line-follower/tianshou/log/LineFollower-v0/sac/policy.pth"))
